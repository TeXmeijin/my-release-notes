        ...
        {release.links && (
          <div className={styles.links}>
            ...
            >
              <img
                border="0"
                src="//ws-fe.amazon-adsystem.com/widgets/q?_encoding=UTF8&MarketPlace=JP&ASIN=B08X11GD52&ServiceVersion=20070822&ID=AsinImage&WS=1&Format=_SL250_&tag=meijin04-22"
              />
            </a>
          </div>
        )}
